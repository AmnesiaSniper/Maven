...
public class RedisUtil {
	...
	public String Object(String key, String str) {
	...
	public Object JavaObject(String jsonStr,Object object){
		JSONObject obj = new JSONObject().fromObject(jsonStr);
		//将json对象转换为java对象
		object = (Object)JSONObject.toBean(obj,Object.class);
		return object;
	}
